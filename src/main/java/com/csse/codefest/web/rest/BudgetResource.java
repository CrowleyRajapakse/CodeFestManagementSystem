...
public class BudgetResource {
    ...
    @GetMapping("/budgets")
    @Timed
    public ResponseEntity<List<BudgetDTO>> getAllBudgets(@ApiParam Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<BudgetDTO>> searchBudgets(@RequestParam String query, @ApiParam Pageable pageable) {
